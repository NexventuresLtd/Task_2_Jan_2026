    ...
    <section className="mx-auto max-w-7xl flex flex-col-reverse md:flex-row items-center gap-8 px-4 py-12 md:py-20">
      <div className="flex flex-col gap-6 md:max-w-xl">
        ...
        <button
          ...
          className="mt-2 cursor-pointer w-max rounded-lg bg-blue-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
        >
          Go to Dashboard
        </button>
      </div>
